...
const VALUES = [
  { label: "Quality", body: "Every detail is considered. We refuse to compromise on materials, process, or finish." },
  { label: "Love", body: "We make things because we love making them — and because we love the rituals they serve." },
  { label: "Creative & Bold", body: "We push form and glaze into new territory without losing sight of function." },
  { label: "Original", body: "No trends, no fast cycles. Each collection is its own complete thought." },
]
...
export function AboutPage() {
  ...
  return (
    <div className="bg-dark text-light">
      ...
      {/* ── Hero ── */}
      <section className="min-h-screen flex flex-col justify-end pb-20 px-8 md:px-16 pt-32">
        <p className="mb-4 text-xs font-medium uppercase tracking-widest text-light/50">About Stryk</p>
        <h1 ref={h1Ref} className="text-128 max-w-4xl font-medium overflow-hidden">
          Let's celebrate
        </h1>
      </section>
      ...
      <section className="grid gap-16 px-8 py-24 md:grid-cols-2 md:px-16">
        <div className="flex flex-col justify-center">
          <p ref={bodyTextRef} className="text-24 max-w-lg text-light/80 leading-relaxed">
      ...
      <section className="grid gap-16 border-t border-light/10 px-8 py-24 md:grid-cols-2 md:px-16">
        <div>
          ...
          <p className="text-64 font-light leading-tight">
      ...
      <section className="bg-[#222] px-8 py-24 md:px-16">
        <p className="mb-4 text-xs font-medium uppercase tracking-widest text-light/50">Our Story</p>
        <h2 ref={storyHeadingRef} className="text-128 mb-16 max-w-3xl font-medium overflow-hidden">
        ...
        <p className="mt-12 max-w-2xl text-18 text-light/60 leading-relaxed">
          Founded by a family of makers, Stryk began as a small studio operation in 2018. We
          wanted to fill a gap — between mass-produced tableware that chips in a year and heirloom
          pieces that cost a fortune. Today we make everything in small batches, by hand, from
      ...
      <section className="px-8 py-24 md:px-16">
        <p className="mb-12 text-xs font-medium uppercase tracking-widest text-light/50">What we stand for</p>
        <div className="grid gap-0 divide-y divide-light/10">
          {VALUES.map((v) => (
            <div key={v.label} className="group flex items-start justify-between gap-8 py-8">
              ...
              <p className="mt-2 max-w-sm text-18 text-light/50">{v.body}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="border-t border-light/10 px-8 py-24 md:px-16">
        <p className="mb-4 text-xs font-medium uppercase tracking-widest text-light/50">Sustainability</p>
      ...
      <footer className="border-t border-light/10 px-8 py-12 md:px-16">
        <div className="flex flex-col gap-8 md:flex-row md:justify-between">
          ...
          <div className="flex gap-8">
            <a href="#" className="text-xs uppercase tracking-widest text-light/40 hover:text-light">
              Instagram
            </a>
            <a href="#" className="text-xs uppercase tracking-widest text-light/40 hover:text-light">
              Pinterest
        ...
        <p className="mt-12 text-xs text-light/20">© {new Date().getFullYear()} Stryk. All rights reserved.</p>
      </footer>
    </div>
  )
}
